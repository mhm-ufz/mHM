...
MODULE mo_global_variables
  ...
  ! type outputVariable
  !    character(32)                    :: name                   ! variable name in netcdf
  !    logical                          :: towrite                ! write variable ?
  !    integer(i4)                      :: varid                  ! store netcdf variable id
  !    real(dp),dimension(:), pointer   :: data                   ! point to data
