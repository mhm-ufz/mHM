...
MODULE mo_global_variables
  ...
  integer(i4) :: wt_for_optional_data ! weight of optional data in OF 67 to 69
  integer(i4) :: swe_threshold_for_spf ! threshold swe to consider as snow presence in OF 75 and 76
