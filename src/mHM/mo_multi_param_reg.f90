...
contains
  ...
  subroutine canopy_intercept_param(proc_Mat, param,             &
    ...
    use mo_upscaling_operators, only: upscale_arithmetic_mean, upscale_geometric_mean
    ...
    case(1)
       ...
       ! Upscale by arithmetic mean
       max_intercept1 = upscale_geometric_mean(Upp_row_L1, Low_row_L1, Lef_col_L1,      &
            Rig_col_L1, mask0, nodata, max_intercept0 )
